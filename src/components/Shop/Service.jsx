              ...
              <div className="relative">
                ...
                <div ref={profileDropdownRef} className={`${isProfileOpen ? 'block' : 'hidden'} absolute right-0 mt-2 w-64 origin-top-right rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50`}>
                  <div className="py-1" role="none">
                    ...
                    <div className="py-1"><a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">Profile</a><a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">Repairs</a><a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">Devices</a><a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">AI Assistant</a></div>
                    <div className="py-1 border-t border-gray-200"><a href="#" className="block px-4 py-3 text-sm text-blue-600 hover:bg-gray-100">Switch to Business</a></div>
                    <div className="py-1 border-t border-gray-200"><a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">Settings</a><a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">Help</a></div>
