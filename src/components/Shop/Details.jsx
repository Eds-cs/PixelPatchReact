...
// The Shop Service Detail Page Component
        ...
        <main className="p-8 flex-grow overflow-y-auto">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 max-w-3xl mx-auto">
                ...
                <div className="flex justify-between items-center pb-4 border-b border-gray-200">
                    ...
                    <a href="#" className="text-sm font-medium text-blue-600 hover:text-blue-800">Edit</a>
                </div>
                ...
                <div className="space-y-6 pt-6">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-semibold text-gray-900 mt-1">Smartphone</p>
                    </div>
                    
                    {/* Repair Service */}
                    <div>
                        <label className="block text-sm font-medium text-gray-500">Repair Service</label>
                        <p className="text-lg font-semibold text-gray-900 mt-1">Screen Replacement</p>
                        <p className="text-sm text-gray-600 mt-1">This is a repair service you provide for the device type selected.</p>
                    </div>
                    
                    {/* Estimated Timeframe */}
                    <div>
                        <label className="block text-sm font-medium text-gray-500">Estimated Timeframe</label>
                        <p className="text-lg font-semibold text-gray-900 mt-1">2 to 4 Days</p>
                        <p className="text-sm text-gray-600 mt-1">This is an estimated timeframe for you to finish the job.</p>
                    </div>
                    
                    {/* Estimated Price */}
                    <div>
                        <label className="block text-sm font-medium text-gray-500">Estimated Price</label>
                        <p className="text-lg font-semibold text-gray-900 mt-1">200.00 PHP</p>
                        <p className="text-sm text-gray-600 mt-1">This is an estimated price for your service.</p>
                    </div>
                </div>
            </div>
        </main>
